...
public class keyword_lv1 : MonoBehaviour {

    //LIST LETTER OF ALIEN MESSAGE
    List<string> listfirst = new List<string> { "H", "E", "L","L", "O" };
    public static List<string> list = new List<string> { "H", "I" };

    //--------------------------------------------------------------------------------------

    //LIST LETTER OF HUMAN MESSAGE
    public static List<string>  humanMessage = new List<string> { "H", "I"};
    ...
    IEnumerator Start()
    {
        ...
        humanMessage_back.GetComponent<Text>().text = "HI";
        started = true;
    }
    void Update()
    {
