...
public class keyword_lv5 : MonoBehaviour
{

    //LIST LETTER OF ALIEN MESSAGE
    List<string> listfirst = new List<string> { "W", "O", "W", "SPACE", "F", "R", "O","M" ,"SPACE", "E", "A", "R", "T", "H" };
    public static List<string> list = new List<string> { "I", "N", "D", "E", "E","D" };

    //--------------------------------------------------------------------------------------

    //LIST LETTER OF HUMAN MESSAGE
    public static List<string> humanMessage = new List<string> { "I", "N", "D", "E", "E", "D" };
    ...
    IEnumerator Start()
    {
        ...
        Button5 = GameObject.FindGameObjectWithTag("key5");
        Color q4 = new Color(Random.value, Random.value, Random.value, 1.0f);
        Button4.GetComponent<Renderer>().material.color = q4;

        Button6 = GameObject.FindGameObjectWithTag("key6");
        Color q5 = new Color(Random.value, Random.value, Random.value, 1.0f);
        Button6.GetComponent<Renderer>().material.color = q5;
        ...
        humanMessage_back.GetComponent<Text>().text = "INDEED";
        started = true;
    }
    void Update()
    {
